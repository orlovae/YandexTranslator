...
public class DBHelper extends SQLiteOpenHelper {
    ...
    private final String SQL_CREATE_TRANSLATE_TABLE = "CREATE TABLE "
            ...
            + Contract.DictionaryEntries.COLUMN_TRANSLATE_SYNONYM_ID + " integer,"
            + Contract.DictionaryEntries.COLUMN_TRANSLATE_MEANING_ID + " integer,"
            + Contract.DictionaryEntries.COLUMN_TRANSLATE_EXAMPLE_ID + " integer, FOREIGN KEY("
            + Contract.DictionaryEntries.COLUMN_TRANSLATE_SYNONYM_ID + ") REFERENCES "
            + Contract.DictionaryEntries.TABLE_NAME_SYNONYM + " ( "
            + Contract.DictionaryEntries.COLUMN_SYNONYM_ID + " ), FOREIGN KEY("
            + Contract.DictionaryEntries.COLUMN_TRANSLATE_MEANING_ID + ") REFERENCES "
            + Contract.DictionaryEntries.TABLE_NAME_MEANING + " ( "
            + Contract.DictionaryEntries.COLUMN_MEANING_ID + " ), FOREIGN KEY("
            + Contract.DictionaryEntries.COLUMN_TRANSLATE_EXAMPLE_ID + ") REFERENCES "
    ...
    private final String SQL_CREATE_EXAMPLE_TABLE = "CREATE TABLE "
            ...
            + Contract.DictionaryEntries.COLUMN_EXAMPLE_EXAMPLE_TRANSLATION_ID + " integer, FOREIGN KEY("
            + Contract.DictionaryEntries.COLUMN_EXAMPLE_EXAMPLE_TRANSLATION_ID + ") REFERENCES "
